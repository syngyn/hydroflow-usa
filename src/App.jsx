...
import AssetsFilesRedirect from './pages/AssetsFilesRedirect';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/SupportIssues" element={<LayoutWrapper currentPageName="SupportIssues"><SupportIssues /></LayoutWrapper>} />
