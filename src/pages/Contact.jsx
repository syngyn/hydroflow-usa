              ...
              <div className="bg-white rounded-2xl p-8">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <a href="http://www.hydroflowcanada.com/" target="_blank" rel="noopener noreferrer" className="text-cyan-600 hover:underline text-sm">
                      HydroFLOW Canada
                    </a>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-700 mb-2">Mexican Customers</h4>
                    <a href="https://hydroflow-mexico.mx/" target="_blank" rel="noopener noreferrer" className="text-cyan-600 hover:underline text-sm">
                      HydroFLOW Mexico
                    </a>
                  </div>
                  <div>
