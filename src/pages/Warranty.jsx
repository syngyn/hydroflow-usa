      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              A claim under this warranty must be submitted by email to <i>Hydro</i>FLOW or the authorized dealer or vendor from which you purchased the Product, and such email must include: (i) a copy of the original receipt or proof of purchase of the Product, (ii) proof that the Product has been installed properly, (iii) a written explanation of the issue(s) with the Product, and (iv) one or more pictures of the Product and surrounding area that displays such issue(s). A <i>Hydro</i>FLOW representative will then review your claim and contact you within 10 business days to coordinate the repair or replacement of the Product or to request additional information.
            </p>
