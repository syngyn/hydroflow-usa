...
const stateTemperatures = {
  ...
  'CA': { name: 'California', temp: 62, range: '51-60°F' },
  'CO': { name: 'Colorado', temp: 48, range: '41-50°F' },
  'CT': { name: 'Connecticut', temp: 49, range: '41-50°F' },
  'DE': { name: 'Delaware', temp: 54, range: '51-60°F' },
  'FL': { name: 'Florida', temp: 71, range: '+71°F' },
  ...
  'ME': { name: 'Maine', temp: 43, range: '41-50°F' },
  ...
  'MS': { name: 'Mississippi', temp: 65, range: '61-70°F' },
  'MO': { name: 'Missouri', temp: 54, range: '51-60°F' },
  'MT': { name: 'Montana', temp: 42, range: '41-50°F' },
  'NE': { name: 'Nebraska', temp: 49, range: '41-50°F' },
  'NV': { name: 'Nevada', temp: 56, range: '51-60°F' },
  'NH': { name: 'New Hampshire', temp: 45, range: '41-50°F' },
  'NJ': { name: 'New Jersey', temp: 52, range: '51-60°F' },
  'NM': { name: 'New Mexico', temp: 58, range: '51-60°F' },
  'NY': { name: 'New York', temp: 51, range: '51-60°F' },
  'NC': { name: 'North Carolina', temp: 59, range: '51-60°F' },
  'ND': { name: 'North Dakota', temp: 38, range: '<40°F' },
  'OH': { name: 'Ohio', temp: 52, range: '51-60°F' },
  'OK': { name: 'Oklahoma', temp: 61, range: '61-70°F' },
  'OR': { name: 'Oregon', temp: 51, range: '51-60°F' },
  'PA': { name: 'Pennsylvania', temp: 51, range: '51-60°F' },
  'RI': { name: 'Rhode Island', temp: 49, range: '41-50°F' },
  'SC': { name: 'South Carolina', temp: 63, range: '61-70°F' },
  'SD': { name: 'South Dakota', temp: 44, range: '41-50°F' },
  'TN': { name: 'Tennessee', temp: 59, range: '51-60°F' },
  'TX': { name: 'Texas', temp: 65, range: '61-70°F' },
  'UT': { name: 'Utah', temp: 50, range: '41-50°F' },
  'VT': { name: 'Vermont', temp: 44, range: '41-50°F' },
  'VA': { name: 'Virginia', temp: 55, range: '51-60°F' },
  'WA': { name: 'Washington', temp: 49, range: '41-50°F' },
  'WV': { name: 'West Virginia', temp: 52, range: '51-60°F' },
  'WI': { name: 'Wisconsin', temp: 45, range: '41-50°F' },
