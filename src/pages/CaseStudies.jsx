...
const caseStudies = [
  // Industrial
  {
    ...
    description: 'EcoTech Solutions installed two <i>Hydro</i>FLOW <i>i</i>-Range units to help saving water in a 5.2 million square foot factory in Texas.',
  ...
  },
  {
    ...
    description: 'After 3 months of operation, <i>Hydro</i>FLOW was able to reduce scaling and maintain consistent flow rates.',
  ...
  // Marine
  {
    ...
    description: '<i>Hydro</i>FLOW succeeded in keeping the strainer free of biofouling for a much longer period.',
