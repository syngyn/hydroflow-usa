...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-slate-900">
      ...
      {/* Video background */}
      <div className={`absolute inset-0 overflow-hidden transition-opacity duration-700 z-0 ${videoLoaded ? 'opacity-65' : 'opacity-0'}`}>
        <iframe
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-32 lg:scale-110 lg:origin-center">
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
           ...
           <motion.div
             ...
             className="flex flex-col justify-center rounded-2xl p-6 md:p-8 bg-slate-900/60 backdrop-blur-sm"
           >
