...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white">
      ...
      <div className="absolute inset-0" style={{backgroundImage: 'url(https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6933444aa399ff1da59bbd5c/5981484d8_Gemini_Generated_Image_djc6ocdjc6ocdjc6.png)', backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.2}} />
